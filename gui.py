...
class Ui_mainWindow(object):
    ...
    def retranslateUi(self, mainWindow):
        ...
        mainWindow.setWindowTitle(_translate("mainWindow", "Vehicle Detection and Classification"))
        self.groupBox_count.setTitle(_translate("mainWindow", "Outputs"))
        ...
        self.pushButton_openVideo.setText(_translate("mainWindow", "SELECT VIDEO"))
        self.pushButton_selectArea.setText(_translate("mainWindow", "SUBMIT AREA"))
